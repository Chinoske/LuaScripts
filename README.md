...
| 🎵 | [YTMusic](./YTMusic/) | In-game UI to open YouTube Music in your browser (requires AIO) |
| 🎶 | [MusicPlayer](./MusicPlayer/) | In-game MP3/OGG music player with playlist, controls and volume (requires AIO) |
